...
const cardIconSource = {
  ...
  Paymongo: AppStyles.iconSet.paymongo,
  stripe: AppStyles.iconSet.stripe,
  cod: AppStyles.iconSet.cod,
};
const stripeMethod = {
  title: 'stripe',
  key: 'stripe',
  iconSource: cardIconSource.stripe,
  last4: 'stripe',
};
const cardMethod = {
  title: 'Credit Card',
  key: 'credit',
  iconSource: cardIconSource.Visa,
  last4: 'Credit Card',
}
const onlineMethod = {
  title: 'Online Banking',
  key: 'online',
  iconSource: cardIconSource.Paymongo,
  last4: 'Online Banking',
}
const codMethod = {
  title: 'Cash On Delivery',
  key: 'COD',
  iconSource: cardIconSource.cod,
  last4: 'COD',
}
...
const checkoutInitialState = {
  ...
  currentOrderId: '',
  paymentMethods: [/* nativePaymentMethod, */ cardMethod, stripeMethod, codMethod, /* onlineMethod */],
  selectedPaymentMethod: cardMethod, // nativePaymentMethod,
};
...
export const checkout = (state = checkoutInitialState, action) => {
  switch (action.type) {
    ...
    case UPDATE_PAYMENT_METHODS:
      console.log('Updating payment method', action.data);
