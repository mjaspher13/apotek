...
export const getETA = async (start, end) => {
  const etaRequestURL = `https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origins=${start.latitude},${start.longitude}&destinations=${end.latitude}%2C${end.longitude}&key=${key}`;
