...
export const localizedErrorMessage = (errorCode) => {
  switch (errorCode) {
    ...
    case ErrorCode.rateLimited:
      return IMLocalized('Too many unsuccessful login attempts. Please try again later.');
    ...
    case ErrorCode.fbAuthFailed:
      return IMLocalized('There was an error logging you in with Facebook; ' +
        'please check that you didn\'t register with an email/password account.');
    case ErrorCode.fbAuthCancelled:
      return IMLocalized('Facebook login cancelled.');
    default:
      return IMLocalized(
